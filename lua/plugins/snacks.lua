	...
	init = function()
		vim.api.nvim_create_autocmd("User", {
			...
			callback = function()
				...
				map("<leader>pgb", function()
					Snacks.picker.grep_buffers()
				end, "Picker buscar texto en buffers abiertos")
				map("<leader>pgw", function()
					Snacks.picker.grep_word()
				end, "Picker buscar texto en seleccion visual o palabra")
				map("<leader>pgl", function()
					Snacks.picker.lines()
				end, "Picker buscar una linea")
